  ...
  return (
    <>
      ...
      <div className="hub-grid">
        <Link className="hub-card" href="/diete" style={{ backgroundImage: `url(${DIETE_PHOTO})` }}>
        ...
        <Link className="hub-card" href="/sport" style={{ backgroundImage: `url(${SPORT_PHOTO})` }}>
          <div className="hub-card-overlay" />
          <div className="icon-badge">
            <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <Link className="hub-card" href="/journal" style={{ backgroundImage: `url(${JOURNAL_PHOTO})` }}>
          <div className="hub-card-overlay" />
          <div className="icon-badge">
            <svg viewBox="0 0 24 24" fill="currentColor">
