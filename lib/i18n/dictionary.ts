...
export const UI_STRINGS = {
  fr: {
    ...
    "nav.diete": "Diète",
    "nav.sport": "Sport",
    "nav.espacePersonnel": "Espace perso",
    ...
    "home.personal.title": "Espace Personnel",
    "home.personal.desc": "Ton journal, tes photos de progression et ton planning — tout ton suivi perso.",
    ...
    "diete.plan.title": "Générateur de diète",
    "diete.plan.subtitle": "Indique ton poids, ton objectif et le nombre de jours : je te propose un menu complet jour par jour, avec les calories et protéines de chaque journée.",
    "diete.plan.field.weight": "Ton poids (kg)",
    "diete.plan.customCalories": "Objectif calories/jour (optionnel)",
    "diete.plan.field.days": "Nombre de jours",
    "diete.plan.generate": "Générer ma diète",
    "diete.plan.dayTotal": "Total du jour",
    "diete.plan.target": "Objectif quotidien",
    "diete.plan.missingWeight": "Indique ton poids pour générer ta diète.",
    "diete.plan.scaleHint": "Portions ajustées pour atteindre ton objectif de calories.",
    "day.mon": "Lundi",
    "day.tue": "Mardi",
    "day.wed": "Mercredi",
    "day.thu": "Jeudi",
    ...
    "empty.logsForExercise": "Aucun poids/répétitions enregistré pour cet exercice pour l'instant.",
    ...
    "empty.noExerciseForMuscle":
      "Aucun exercice enregistré pour ce muscle pour l'instant.",
    ...
    "status.importDetail": "{success} ({trainings} entraînements, {meals} repas, {photos} photos)",
    "status.importErrors": " — {count} erreur(s)",
    ...
    "hub.journal.title": "Journal",
    "hub.journal.desc": "L'historique de mes poids/reps utilisés et des repas que j'ai mangés.",
    "hub.progression.title": "Progression",
    "hub.progression.desc": "Tes photos de progression physique, dans l'ordre, avec le poids si tu veux le noter.",
    "hub.planificateur.title": "Planning",
    "hub.planificateur.desc": "Organise tes repas et séances sur le calendrier de la semaine.",

    "personal.kicker": "Discipline · Constance · Preuves",
    "personal.title": "Espace Personnel",
    "personal.subtitle": "Ton historique d'entraînement, tes photos de progression et ton planning — tout ton suivi, au même endroit.",
    ...
    "programme.field.style": "Ton style",
    "programme.style.gym": "Salle de sport",
    "programme.style.calisthenics": "Calisthénie",
    "programme.style.mix": "Mélange",
    ...
    "programme.removeExercise": "Retirer cet exercice",
    "programme.addExercise": "Ajouter",
    "programme.pickExerciseToAdd": "Ajouter un exercice...",
    ...
    "programme.shopping.emptyRecipes":
      "Pas encore assez de recettes dans cette catégorie pour remplir tous les jours — certains repas se répètent.",
    ...
    "placeholder.addPhoto": "Photo à venir",
    "placeholder.addVideo": "Vidéo à venir",
    ...
    "chat.openLabel": "Ouvrir le chat Claude",
    "chat.settings": "Réglages",
    "chat.close": "Fermer",
    "chat.inputPlaceholder": "Écris ton message...",
    "chat.apiKeyIntro": "Colle ta clé API Anthropic (créée sur",
    "chat.apiKeyLabel": "Clé API",
    "chat.modelLabel": "Modèle",
    "chat.apiKeyStorageNote": "Elle est stockée sur ton compte, jamais ailleurs qu'à l'API Anthropic.",
    "chat.modelHint": "Si le modèle indiqué ne fonctionne pas, vérifie l'identifiant exact dans la doc Anthropic.",
    "chat.save": "Enregistrer",
    "chat.clearHistory": "Effacer la conversation",
    "chat.errorPrefix": "Erreur : ",
    "chat.emptyReply": "(réponse vide)",
  },
  es: {
    "label.languages": "Idiomas",
    "nav.toggleMenu": "Abrir/cerrar el menú",
    "nav.accueil": "Inicio",
    "nav.diete": "Dieta",
    "nav.sport": "Deporte",
    "nav.espacePersonnel": "Espacio personal",
    ...
    "home.personal.title": "Espacio Personal",
    "home.personal.desc": "Tu diario, tus fotos de progreso y tu planificador — todo tu seguimiento personal.",
    ...
    "diete.plan.title": "Generador de dieta",
    "diete.plan.subtitle": "Indica tu peso, tu objetivo y el número de días: te propongo un menú completo día por día, con las calorías y proteínas de cada jornada.",
    "diete.plan.field.weight": "Tu peso (kg)",
    "diete.plan.customCalories": "Objetivo calorías/día (opcional)",
    "diete.plan.field.days": "Número de días",
    "diete.plan.generate": "Generar mi dieta",
    "diete.plan.dayTotal": "Total del día",
    "diete.plan.target": "Objetivo diario",
    "diete.plan.missingWeight": "Indica tu peso para generar tu dieta.",
    "diete.plan.scaleHint": "Porciones ajustadas para alcanzar tu objetivo de calorías.",
    "day.mon": "Lunes",
    "day.tue": "Martes",
    "day.wed": "Miércoles",
    "day.thu": "Jueves",
    ...
    "empty.logsForExercise": "Todavía no hay ningún peso/repeticiones registrado para este ejercicio.",
    ...
    "empty.noExerciseForMuscle":
      "Todavía no hay ningún ejercicio registrado para este músculo.",
    ...
    "status.importDetail": "{success} ({trainings} entrenos, {meals} comidas, {photos} fotos)",
    "status.importErrors": " — {count} error(es)",
    ...
    "hub.journal.title": "Diario",
    "hub.journal.desc": "El historial de los pesos/repeticiones usados y de las comidas que he comido.",
    "hub.progression.title": "Progreso",
    "hub.progression.desc": "Tus fotos de progreso físico, en orden, con el peso si quieres anotarlo.",
    "hub.planificateur.title": "Planificador",
    "hub.planificateur.desc": "Organiza tus comidas y sesiones en el calendario de la semana.",

    "personal.kicker": "Disciplina · Constancia · Pruebas",
    "personal.title": "Espacio Personal",
    "personal.subtitle": "Tu historial de entrenamiento, tus fotos de progreso y tu planificador — todo tu seguimiento, en un mismo lugar.",
    ...
    "programme.field.style": "Tu estilo",
    "programme.style.gym": "Gimnasio",
    "programme.style.calisthenics": "Calistenia",
    "programme.style.mix": "Mezcla",
    ...
    "programme.removeExercise": "Quitar este ejercicio",
    "programme.addExercise": "Añadir",
    "programme.pickExerciseToAdd": "Añadir un ejercicio...",
    ...
    "programme.shopping.emptyRecipes":
      "Todavía no hay suficientes recetas en esta categoría para llenar todos los días — algunas comidas se repiten.",
    ...
    "placeholder.addPhoto": "Foto próximamente",
    "placeholder.addVideo": "Vídeo próximamente",
    ...
    "chat.openLabel": "Abrir el chat de Claude",
    "chat.settings": "Ajustes",
    "chat.close": "Cerrar",
    "chat.inputPlaceholder": "Escribe tu mensaje...",
    "chat.apiKeyIntro": "Pega tu clave API de Anthropic (creada en",
    "chat.apiKeyLabel": "Clave API",
    "chat.modelLabel": "Modelo",
    "chat.apiKeyStorageNote": "Se guarda en tu cuenta, nunca va a ningún sitio salvo a la API de Anthropic.",
    "chat.modelHint": "Si el modelo indicado no funciona, comprueba el identificador exacto en la documentación de Anthropic.",
    "chat.save": "Guardar",
    "chat.clearHistory": "Borrar la conversación",
    "chat.errorPrefix": "Error: ",
    "chat.emptyReply": "(respuesta vacía)",
  },
} as const;
